...
void MainWindow::createMenus()
{
    ...
    openMenu = new QMenu(tr("&Open"), this);
    openViewsMenu = new QMenu(tr("&To view"), this);
    createNewViewMenu = new QMenu(tr("&New view"), this);

    menuBar()->addMenu(fileMenu);
    menuBar()->addMenu(openMenu);
    menuBar()->addMenu(openViewsMenu);
    menuBar()->addMenu(createNewViewMenu);
